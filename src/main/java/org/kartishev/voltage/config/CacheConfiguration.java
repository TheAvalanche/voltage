package org.kartishev.voltage.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.setInstanceName("Voltage");
        ...
        config.getMapConfigs().put("org.kartishev.voltage.domain.*", initializeDomainMapConfig(jHipsterProperties));
